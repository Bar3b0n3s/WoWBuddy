...
public static class CapabilityProbes
{
    ...
    [
        ...
        new(GameCapability.Party,
            ...
            ["GetNumPartyMembers", "GetNumRaidMembers", "UnitGUID", "UnitName", "UnitIsUnit",
             "UnitHealth", "UnitHealthMax", "UnitIsDeadOrGhost", "UnitIsConnected",
             "UnitIsPartyLeader", "UnitAffectingCombat", "IsInInstance", "FollowUnit"],
